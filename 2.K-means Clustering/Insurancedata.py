...
#============================================================================
# Dropping the perfectly redundant Income column to avoid duplicating data weight
df1 = df.drop(columns=['Income'])

# Capping extreme upper claim values to stabilize cluster spatial distance mapping
